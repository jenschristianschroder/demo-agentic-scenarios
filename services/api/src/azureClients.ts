...
const AZURE_OPENAI_DALLE_DEPLOYMENT = process.env.AZURE_OPENAI_DALLE_DEPLOYMENT || 'gpt-image-2';
 ...
 * Uses the AZURE_OPENAI_DALLE_DEPLOYMENT environment variable (default: 'gpt-image-2').
 */
