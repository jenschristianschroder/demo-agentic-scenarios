          ...
          <div key={iter.iteration} className="iteration-entry">
            ...
            {iter.revisionOutput && (
              <div className="iteration-section">
                ...
                <p className="iteration-text">{iter.revisionOutput.revisedText}</p>
                <div className="iteration-changes">
                  {iter.revisionOutput.changesApplied.map((change, i) => (
                    <span key={i} className="iteration-change">
                      ✎ {change}
                    </span>
                  ))}
                </div>
